...
class Voter:
    ...
    def assign_control_key(self):
        ...
        self.contract.functions.assign_control_key(self.address,encrypted_key,self.election_name).transact()
    
    def authorize_control_address(self):
        self.contract.functions.authorize_control_address(self.election_name,self.control_address).transact()
