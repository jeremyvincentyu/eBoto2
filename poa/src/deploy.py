...
#Assume starting directory is project root (new_eboto in container, eboto2 in VM)
import json
...
with open("poa/build/EA_Account_sol_EA_Account.abi","r") as abi_file:
    abi_string = abi_file.read()
    abi = json.loads(abi_string)

with open("poa/build/EA_Account_sol_EA_Account.bin","r") as bytecode_file:
